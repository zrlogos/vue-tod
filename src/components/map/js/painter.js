...
import './libs/limitTextNum.js';
import './libs/svg-pan-zoom.js';
...
let eventsHandler = {
    ...
    init: function (options) {
        ...
        this.hammer.on('pinchout', function () {
            instance.zoomIn()
        })
        this.hammer.on('pinchin', function () {
            instance.zoomOut()
        })
